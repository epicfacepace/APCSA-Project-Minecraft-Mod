...
public abstract class AbstractInfuserTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return AbstractInfuserTileEntity.this.burnTime;
                case 1:
                    return AbstractInfuserTileEntity.this.recipesUsed;
                case 2:
                    return AbstractInfuserTileEntity.this.cookTime;
                case 3:
                    return AbstractInfuserTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    AbstractInfuserTileEntity.this.burnTime = value;
                    break;
                case 1:
                    AbstractInfuserTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    AbstractInfuserTileEntity.this.cookTime = value;
                    break;
                case 3:
                    AbstractInfuserTileEntity.this.cookTimeTotal = value;
            }
    ...
    protected AbstractInfuserTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn) {
        super(tileTypeIn);

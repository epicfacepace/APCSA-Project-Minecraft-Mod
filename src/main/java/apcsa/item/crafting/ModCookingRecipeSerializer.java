...
public class ModCookingRecipeSerializer<T extends AbstractModCookingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
    private final int field_222178_t;
    private final ModCookingRecipeSerializer.IFactory<T> field_222179_u;

    public ModCookingRecipeSerializer(ModCookingRecipeSerializer.IFactory<T> p_i50025_1_, int p_i50025_2_) {
    ...
    public interface IFactory<T extends AbstractModCookingRecipe> {
